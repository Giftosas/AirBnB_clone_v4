...
## Web Dynamic Infrastructure

### Flask Web Application

A Flask instance can be started by entering the following:

```
user@ubuntu:~/AirBnB_v4$ HBNB_MYSQL_USER=hbnb_dev
...
....
```
While running, a user can enter `0.0.0.0:5000/3-hbnb/` for example, into their
web browser and view the hbnb site, while interacting with the limited functionality,
as seen below.

### Demo

![Holberton AirBnB Clone Demo](demo/demogif.gif)
---
...
* Nick O'Keefe, [GitHub: nokeefe](https://github.com/nokeefe) | [LinkedIn: Nick O'Keefe](https://www.linkedin.com/in/nbokeefe/)
* John Cook, [GitHub: JohnCook17](https://github.com/JohnCook17) | [LinkedIn: John Cook](https://www.linkedin.com/in/john-cook-17a13b17a/)
